...
чтобы не допустить обработку несуществующего римского числа,
например: "IIII" или "VV".
По условию задачи на вход доступны только числа от 1 до 10, 
поэтому можно обойтись сравнением входных данных со списком допустимых значений,
используя цикл.
*/
